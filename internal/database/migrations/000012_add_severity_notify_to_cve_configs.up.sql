...
ALTER TABLE cve_configs ADD COLUMN notify_on_moderate BOOLEAN DEFAULT FALSE AFTER notify_on_high;
ALTER TABLE cve_configs ADD COLUMN notify_on_low BOOLEAN DEFAULT FALSE AFTER notify_on_moderate;